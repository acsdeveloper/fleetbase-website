var cookieconsent = (function (e) {
    ...
    function (e, t, i) {
        ...
        function d(e, t) {
            for (var i = 0; i < e.length; i++) {
                ...
                if (a) {
                    ...
                    for (; r < n.parts.length; r++) a.parts.push(y(n.parts[r], t));
                } else {
                    var s = [];
                    for (r = 0; r < n.parts.length; r++) s.push(y(n.parts[r], t));
        ...
        function y(e, t) {
            ...
            if (t.singleton) {
                var r = p++;
                (i = l || (l = b(t))), (n = x.bind(null, i, r, !1)), (a = x.bind(null, i, r, !0));
            } else
                e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa
                    ? ((i = (function (e) {
                          var t = document.createElement("link");
                          return void 0 === e.attrs.type && (e.attrs.type = "text/css"), (e.attrs.rel = "stylesheet"), f(t, e.attrs), m(e, t), t;
                      })(t)),
                      (n = j.bind(null, i, t)),
                      (a = function () {
        ...
        function j(e, t, i) {
            ...
            (t.convertToAbsoluteUrls || o) && (n = _(n)), a && (n += "\n/*# sourceMappingURL=data:application/json;base64," + btoa(unescape(encodeURIComponent(JSON.stringify(a)))) + " */");
    ...
    function (e) {
        e.exports = JSON.parse(
            '{"i18n":{"active":"تغيير تفضيلاتي","always_active":"مفعل دائمًا","impressum":"<a href=\'%s\' target=\'_blank\'>Impressum</a>","inactive":"غير مفعل","nb_agree":"موافق","nb_changep":"تغيير تفضيلاتي","nb_ok":"فهمت","nb_reject":"أرفض","nb_text":"يستخدم موقع الويب هذا ملفات تعريف الارتباط وتقنيات التتبع الأخرى لتحسين تجربة التصفح لديك للأغراض التالية: %s.","nb_text_purposes_analytics":"لتحليل استخدام الموقع وتحسين أدائه","nb_text_purposes_functionality":"لتوفير تجربة أفضل على الموقع","nb_text_purposes_strictly-necessary":"لتمكين الوظائف الأساسية للموقع","nb_text_purposes_targeting":"لتقديم إعلانات أكثر ملاءمة لك","nb_text_purposes_tracking":"لقياس مدى اهتمامك بمنتجاتنا وخدماتنا ولتخصيص التفاعلات التسويقية","nb_title":"نحنُ نستخدم ملفات تعريف الارتباط","pc_fnct_text_1":"ملفات تعريف الارتباط الوظيفية","pc_fnct_text_2":"تُستخدم ملفات تعريف الارتباط هذه لتزويدك بتجربة أكثر تخصيصًا على موقعنا الإلكتروني ولتذكر الخيارات التي تتخذها عند استخدامك لموقعنا.","pc_fnct_text_3":"على سبيل المثال ، قد نستخدم ملفات تعريف الارتباط الوظيفية لتذكر تفضيلات اللغة الخاصة بك أو تذكر تفاصيل تسجيل الدخول الخاصة بك.","pc_minfo_text_1":"معلومات أكثر.","pc_minfo_text_2":"لأي استفسارات تتعلق بسياستنا الخاصة بملفات تعريف الارتباط ، وخياراتك،  يرجى التواصل معنا.","pc_minfo_text_3":"<a href=\'%s\' target=\'_blank\'>الخاصة بنا لمعرفة المزيد ، يرجى زيارةسياسة الخصوصية .</a>","pc_save":"حفظ تفضيلاتي","pc_sncssr_text_1":"ملفات تعريف الارتباط الضرورية للغاية","pc_sncssr_text_2":"تعد ملفات تعريف الارتباط هذه ضرورية لتزويدك بالخدمات المتاحة عبر موقعنا على الويب ولتمكينك من استخدام ميزات معينة في موقعنا .","pc_sncssr_text_3":"بدون ملفات تعريف الارتباط هذه ، لا يمكننا تقديم خدمات معينة لك على موقعنا.","pc_title":"مركز تفضيلات ملفات تعريف الارتباط","pc_trck_text_1":"ملفات تعريف الارتباط للتتبع والأداء","pc_trck_text_2":"تُستخدم ملفات تعريف الارتباط هذه لجمع المعلومات لتحليل حركة المرور إلى موقعنا الإلكتروني وكيفية استخدام الزوار لموقعنا.","pc_trck_text_3":"على سبيل المثال ، قد تتعقب ملفات تعريف الارتباط هذه أشياء مثل المدة التي تقضيها على موقع الويب أو الصفحات التي تزورها مما يساعدنا على فهم كيف يمكننا تحسين موقعنا على الويب من أجلك.","pc_trck_text_4":"المعلومات التي يتم جمعها من خلال ملفات تعريف الارتباط الخاصة بالتتبع والأداء هذه لا تحدد أي زائر فردي.","pc_trgt_text_1":"ملفات تعريف الارتباط الخاصة بالاستهداف والإعلان","pc_trgt_text_2":"تُستخدم ملفات تعريف الارتباط هذه لإظهار الإعلانات التي من المحتمل أن تهمك بناءً على عاداتك في التصفح.","pc_trgt_text_3":"قد تدمج ملفات تعريف الارتباط هذه ، كما يقدمها المحتوى و / أو موفرو الإعلانات لدينا ، المعلومات التي جمعوها من موقعنا الإلكتروني مع المعلومات الأخرى التي جمعوها بشكل مستقل فيما يتعلق بأنشطة متصفح الويب الخاص بك عبر شبكة مواقعهم الإلكترونية.","pc_trgt_text_4":"إذا اخترت إزالة أو تعطيل ملفات تعريف الارتباط الخاصة بالاستهداف أو الإعلانات ، فستظل تشاهد إعلانات ولكنها قد لا تكون ذات صلة بك.","pc_yprivacy_text_1":"خصوصيتك مهمة بالنسبة لنا","pc_yprivacy_text_2":"من الأغراض ولتعزيز تجربتك عبر الإنترنت على موقعنا (على سبيل المثال ، لتذكر تفاصيل تسجيل الدخول إلى حسابك).","pc_yprivacy_text_3":"يمكنك تغيير تفضيلاتك ورفض أنواع معينة من ملفات تعريف الارتباط ليتم تخزينها على جهاز الكمبيوتر الخاص بك أثناء تصفح موقعنا على الويب.  يمكنك أيضًا إزالة أي ملفات تعريف ارتباط مخزنة بالفعل على جهاز الكمبيوتر الخاص بك ، ولكن ضع في اعتبارك أن حذف ملفات تعريف الارتباط قد يمنعك من استخدام أجزاء من موقعنا.","pc_yprivacy_title":"خصوصيتك","privacy_policy":"<a href=\'%s\' target=\'_blank\'>ةسياسة الخصوصية</a>"}}'
        );
    },
    function (e) {
        e.exports = JSON.parse(
                ...
                return (
                    ...
                    (e.prototype.cc_noticeBannerOkOrAgreePressed = function () {
                        ...
                        document.addEventListener("cc_noticeBannerOkOrAgreePressed", function () {
                            (this.userConsentTokenClass = new _e(e.cookieConsent)),
                    ...
                    (e.prototype.cc_noticeBannerRejectPressed = function () {
                        ...
                        window.addEventListener("cc_noticeBannerRejectPressed", function () {
                            (this.userTokenClass = new _e(e.cookieConsent)),
            ...
            X = (function () {
                ...
                return (
                    ...
                    (e.prototype.initPreferenceItems = function () {
                        ...
                        try {
                            for (var i = $(this.cookieLevels), n = i.next(); !n.done; n = i.next()) {
                                var a = n.value;
                ...
                return (
                    ...
                    (e.prototype.showPreferencesCenter = function () {
                        ...
                        t.cookieConsent.log("preferencesCenterOverlayModal_firstFocusableElement: " + n, "info"),
                            ...
                            this.preferencesCenterOverlay.classList.add(F + "---lang-" + t.cookieConsent.i18n.userLang);
                    }),
                    (e.prototype.hidePreferencesCenter = function () {
                        this.preferencesCenterOverlay.classList.remove(F + "---is-visible"), this.cookieConsent.log("Preferences Center hidden", "info");
                    }),
                    ...
                    (e.prototype.createPreferencesCenterOverlayAndDialog = function () {
                        ...
                        if ((r.classList.add("cc-pc-head-title"), e.cookieConsent.ownerWebsiteName.length > 2)) {
                            ...
                            s.classList.add("cc-pc-head-title-text"), (s.innerText = e.cookieConsent.ownerWebsiteName), o.appendChild(r, s);
                        }
                        var c = document.createElement("p");
                        c.classList.add("cc-pc-head-title-headline"), c.setAttribute("id", "cc-pc-head-title-headline"), (c.innerHTML = e.cookieConsent.i18n.$t("i18n", "pc_title")), o.appendChild(r, c);
                        ...
                        _.classList.add("cc-cp-body");
                        var d = this.getMenuContainer(),
                            k = this.getContentContainer();
                        o.appendChild(_, d), o.appendChild(_, k);
                        var m = this.getFooterContainer();
                        return o.appendChild(n, a), o.appendChild(n, _), o.appendChild(n, m), o.appendChild(i, n), o.appendChild(t, i), t;
                    }),
                        ...
                        return (
                            e.cookieConsent.cookieLevels.preferenceItems.forEach(function (n) {
                                ...
                                r.classList.add("cc-cp-body-tabs-item-link"),
                                    ...
                                    (r.innerHTML = n.title),
                                    0 === i && (a.setAttribute("active", "true"), r.setAttribute("aria-selected", "true"), r.setAttribute("tabindex", "0")),
                                    i++,
                    ...
                    (e.prototype._getLevelCheckbox = function (e) {
                        ...
                        if ((i.classList.add("cc-custom-checkbox"), "strictly-necessary" !== e.id)) {
                            ...
                            a.setAttribute("cookie_consent_toggler", "true"),
                                ...
                                n[e.id]
                                    ? (a.setAttribute("checked", "checked"), a.setAttribute("aria-checked", "true"), r.setAttribute("class", "is-active"), (r.innerHTML = t.cookieConsent.i18n.$t("i18n", "active")))
                                    : (a.setAttribute("aria-checked", "false"), r.setAttribute("class", "is-inactive"), (r.innerHTML = t.cookieConsent.i18n.$t("i18n", "inactive"))),
            ...
            te = (function () {
                ...
                return (
                    ...
                    (e.prototype.hideNoticeBanner = function () {
                        try {
                            this.noticeBanner.classList.add(F + "---is-hidden"), this.cookieConsent.log("Notice Banner hidden", "info");
                        } catch (e) {}
                    }),
                    (e.prototype.createNoticeBanner = function () {
                        ...
                        if (
                            ...
                            try {
                                for (var n = $(this.noticeBannerExtraCss), a = n.next(); !a.done; a = n.next()) {
                                    var r = a.value;
                                    i.classList.add(r);
                                }
                            } catch (t) {
                        ...
                        if ((i.classList.add(F + "---lang-" + this.cookieConsent.i18n.userLang), o.appendChild(i, this.createNoticeBannerContent()), "interstitial" === this.cookieConsent.ownerNoticeBannerType)) {
                            var s = document.createElement("div");
                            return s.classList.add(F + "---nb-interstitial-overlay"), o.appendChild(s, i), s;
                        }
                        return i;
                    }),
                    ...
                    (e.prototype.createNoticeBannerContent = function () {
                        ...
                        r.classList.add("cc-nb-text"), r.setAttribute("id", "cc-nb-text");
                        try {
                            var s = '<span class="cc-nb-text-purposes">' + e.getUniquePurposesText(!0) + "</span>",
                                c = e.cookieConsent.i18n.$t("i18n", "nb_text", [s]);
                            r.innerHTML = '<span class="cc-nb-text-content">' + c + "</span>";
                        } catch (t) {
                        ...
                        _.classList.add("cc-nb-text-urls-separator"),
                            (_.innerHTML = " | "),
                        ...
                        k.classList.add("cc-nb-okagree"),
                            k.setAttribute("role", "button"),
                            "express" == e.cookieConsent.ownerConsentType ? (k.innerHTML = e.cookieConsent.i18n.$t("i18n", "nb_agree")) : (k.innerHTML = e.cookieConsent.i18n.$t("i18n", "nb_ok")),
                        ...
                        m.classList.add("cc-nb-reject"),
                            ...
                            "express" == e.cookieConsent.ownerConsentType && !1 === e.cookieConsent.ownerNoticeBannerRejectButtonHide && o.appendChild(d, m);
                ...
                function e(e) {
                    switch (
                        ...
                        case "express":
                            ...
                            break;
                        case "implied":
                            (this.consentType = new se(this)), (this.userConsentTokenClass = new _e(this));
                    }
