var cookieconsent = (function (e) {
    ...
    const termsAndConditions = {
        en: {
          ...
          content: [
            "1. Use of Content: All information on this website is for general informational purposes only. Accuracy is not guaranteed, and content is subject to change without notice.",
            "2. No Liability: We are not liable for any damages or losses arising from the use of this website.",
            "3. Intellectual Property: All content, including text, images, and design, is owned by us and cannot be reproduced without permission.",
            "4. Third-Party Links: We are not responsible for external websites linked here.",
            "5. Contact Form: By using the contact form, you consent to us storing and using your submitted data to respond to your inquiry.",
            "6. Privacy: Your personal information is handled as outlined in our Privacy Policy.",
            "7. Governing Law: These terms are governed by the laws of [Your Jurisdiction].",
